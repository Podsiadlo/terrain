...
private:
    ...
    void read_from_file(int north_border_int, int west_border_int, size_t rows, size_t cols,
                        int first_row, int first_col, double **map_data, const std::string map_dir);

    void skip_outliers(double *const *map_data, size_t length, size_t width);

    void get_filename(char *filename, const std::string map_dir, int west_border_int,
...
public:
    ...
    Map *read_SRTM(const double west_border, const double north_border, const double east_border,
                   const double south_border, const std::string map_dir);
};
